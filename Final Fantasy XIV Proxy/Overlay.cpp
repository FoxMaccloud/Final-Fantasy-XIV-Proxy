...
static int correctDXGIFormat(int eCurrentFormat)
{
...
static void CreateRenderTarget(IDXGISwapChain* pSwapChain)
{
    ...
    if (pBackBuffer)
    {
        ...
        desc.Format = static_cast<DXGI_FORMAT>(correctDXGIFormat(sd.BufferDesc.Format));
...
Overlay::Overlay()
{
    g_hwnd = HelperFunctions::GetProcessWindow();

    LOG("[+] Constructing Overlay!\n");
